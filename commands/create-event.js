...
async execute(interaction, client) {
	try {
		...
		try {
			...
			sql = "UPDATE `"+ global.config.mysql_database +"`.`eventmanager__events` SET `signupmessage` = "+ signupmessageid.id +", `mainchannel` = "+ channel.id +", `signupchannel` = "+ signupchannel.id +",`helpchannel` = "+ helpchannel.id +",`textchannel` = "+ textchannel.id +",`staffchannel` = "+ staffchannel.id +",`participantrole` = "+ participantRole.id +",`staffrole` = "+ staffRole.id +",`waitlistrole` = "+ waitlistRole.id +" WHERE `id` = "+ eventid +"";
