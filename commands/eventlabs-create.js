		...
		var errors = "Woups, this didnt work as intented";
			...
			try {
				...
				if (result.length < 5) {
					...
					sql = "INSERT INTO `"+ global.config.mysql_database +"`.`eventmanager__events` VALUES (NULL,'EVENTLABS','"+ eventname +"',"+ interaction.user.id +",NOW(),NULL,NULL,NULL,"+ eventlabsserverid +",1,'CLOSED',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,0,0,0,1,0,0,0,1)";
